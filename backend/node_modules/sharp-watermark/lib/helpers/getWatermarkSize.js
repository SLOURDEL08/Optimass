 ...
 */
var getWatermarkSize = function (mainImage, ratio) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, mainImageHeight, mainImageWidth, waterMarkHeight, waterMarkWidth;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, mainImage
                    .metadata()
                    .then(function (_a) {
            ...
            case 1:
                _a = _b.sent(), mainImageHeight = _a.height, mainImageWidth = _a.width;
                if (!mainImageHeight || !mainImageWidth)
                    throw errorMessages_1.INVALID_IMAGE;
                waterMarkHeight = Math.round(mainImageHeight * ratio);
                waterMarkWidth = Math.round(mainImageWidth * ratio);
                return [2 /*return*/, { waterMarkHeight: waterMarkHeight, waterMarkWidth: waterMarkWidth }];
        }
    });
}); };
exports.default = getWatermarkSize;
